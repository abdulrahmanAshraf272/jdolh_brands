      ...
      body: GetBuilder<AddItemOptionsController>(
        builder: (controller) => Column(
          children: [
            ...
            controller.isPriceDep ? const SizedBox() : TitleAndIsBasicToggle(),
            Row(
              children: [
                Expanded(
              ...
              child: controller.addedOptionElement.isNotEmpty
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) => ItemOptionListItem(
                            ...
                            price: controller.addedOptionElement[index].price,
                            onTapDelete: () => controller.deleteElement(index),
                          ))
